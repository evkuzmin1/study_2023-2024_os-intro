...
![Запуск локального сервера](image/1.png){#fig:001 width=70%}
 ...
 Вставляю ссылки и иконки на ресурсы по заданию (рис. 2)

![Добавление ссылок](image/2.png){#fig:002 width=70%}

 Добавляю пост по прошедшей неделе в папке posts (рис. 3)

![Пост по прошедшей неделе](image/3.png){#fig:003 width=70%}

 Добавила пост на тему по выбору (оформление отчета) в папке posts (рис. 4)

![Пост про оформление отчета](image/4.png){#fig:004 width=70%}

 Закрываю локальный сервер с помощью клавиш Ctrl+C и собираю сайт с изменениями, введя команду ~/bin/hugo без аргументов. Отправляю изменения на GitHub (рис. 5) 

![Отправка изменений на Git](image/5.png){#fig:005 width=70%}

Проверяю, что все сделано корректно (рис. 6)

![Результат выполнения работы](image/6.png){#fig:006 width=70%}
